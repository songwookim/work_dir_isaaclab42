...
from custom_assets.universal_robots import UR10_CFG, UR10_DCLAW_CFG
...
def design_scene() -> tuple[dict, list[list[float]]]:
    ...
    # -- Robot
    ur10_dclaw_cfg = UR10_DCLAW_CFG.replace(prim_path="/World/Origin1/Robot")
    ur10_dclaw_cfg.init_state.pos = (0.0, 0.0, 1.03)
